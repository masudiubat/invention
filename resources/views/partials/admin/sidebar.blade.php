        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.adservice.index')}}" class="{{ request()->routeIs('admin.adservice*') ? 'nav-link active' : 'nav-link' }}">
                        <i class="nav-icon fas fa-concierge-bell"></i>
                        <p> Services </p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('admin.adminproject.type.index')}}" class="{{ request()->routeIs('admin.adminproject.type*') ? 'nav-link active' : 'nav-link' }}">
